...
Variables  /home/${USER}/Downloads/srfwtf-master/OpenSnaproute_Variables/Variables.py
...
Testcase1
    ...
    CHECKPOINT  1.3 Flaping interface state on devices and verifying
...
TC1:Verify LLDP
     LLDP_NEIGHBOR_INFO  ${device_all}  ${fab_count}  ${csw_count}  ${asw_count}  ${device_list}  ${fab}  ${csw}  ${asw}  ${interface_dict}
